...
public class TodoService {
    ...
    public Page<TodoSearchResponse> getSearch(int page, int size, String title, LocalDate startDate, LocalDate endDate, String nickname) {
        Pageable pageable = PageRequest.of(page - 1, size);

        return todoRepository.findBySearch(title, startDate, endDate, nickname, pageable);
    }
}
